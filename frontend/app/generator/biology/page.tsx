...
import { ArrowLeft, ArrowRight, Microscope, Send, Save, AlertCircle } from "lucide-react";
...
export default function CreateDCC() {
  useEffect(() => {
    document.title = "Biology | Generator | DiCCA";
  }, []);
  ...
  return (
    <div className="container mx-auto py-8 pt-20">
      ...
      <div className="text-center mt-6">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-pink-50 border border-pink-200 rounded-3xl shadow-sm">
          <Microscope className="text-pink-500 w-7 h-7" />
          <h1 className="text-2xl font-semibold text-pink-900 tracking-wide">
            {t("biologi")}
          </h1>
        </div>
      </div>
