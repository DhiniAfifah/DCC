...
import { ArrowLeft, ArrowRight, FlaskConical, Send, Save, AlertCircle } from "lucide-react";
...
export default function CreateDCC() {
  useEffect(() => {
    document.title = "Chemistry | Generator | DiCCA";
  }, []);
  ...
  return (
    <div className="container mx-auto py-8 pt-20">
      ...
      <div className="text-center mt-6">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-green-100 border border-green-300 rounded-3xl shadow-sm">
          <FlaskConical className="text-green-600 w-7 h-7" />
