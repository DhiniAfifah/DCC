...
import { ArrowLeft, ArrowRight, Weight, Send, Save, AlertCircle } from "lucide-react";
...
export default function CreateDCC() {
  useEffect(() => {
    document.title = "Mass | Generator | DiCCA";
  }, []);
  ...
  return (
    <div className="container mx-auto py-8 pt-20">
      ...
      <div className="text-center mt-6">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-gray-200 border border-gray-300 rounded-3xl shadow-sm">
          <Weight className="text-gray-600 w-7 h-7" />
