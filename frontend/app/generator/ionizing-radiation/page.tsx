...
import { ArrowLeft, ArrowRight, Radiation, Send, Save, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="container mx-auto py-8 pt-20">
      ...
      <div className="text-center mt-6">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-yellow-50 border border-yellow-200 rounded-3xl shadow-sm">
          <Radiation className="text-yellow-500 w-7 h-7" />
          <h1 className="text-2xl font-semibold text-yellow-800 tracking-wide">
            {t("radiasi")}
          </h1>
        </div>
      </div>
