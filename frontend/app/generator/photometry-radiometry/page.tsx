...
import { ArrowLeft, ArrowRight, Lightbulb, Send, Save, AlertCircle } from "lucide-react";
...
export default function CreateDCC() {
  useEffect(() => {
    document.title = "Photometry & Radiometry | Generator | DiCCA";
  }, []);
  ...
  return (
    <div className="container mx-auto py-8 pt-20">
      ...
      <div className="text-center mt-6">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-purple-50 border border-purple-200 rounded-3xl shadow-sm">
          <Lightbulb className="text-purple-600 w-7 h-7" />
          <h1 className="text-2xl font-semibold text-purple-900 tracking-wide">
            {t("fotometri_radiometri")}
          </h1>
        </div>
      </div>
