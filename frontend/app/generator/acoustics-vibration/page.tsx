...
import { ArrowLeft, ArrowRight, AudioWaveform, Send, Save, AlertCircle } from "lucide-react";
...
export default function CreateDCC() {
  useEffect(() => {
    document.title = "Acoustics & Vibration | Generator | DiCCA";
  }, []);
  ...
  return (
    <div className="container mx-auto py-8 pt-20">
      ...
      <div className="text-center mt-6">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-lime-50 border border-lime-200 rounded-3xl shadow-sm">
          <AudioWaveform className="text-lime-600 w-7 h-7" />
          <h1 className="text-2xl font-semibold text-lime-900 tracking-wide">
            {t("akustik_vibrasi")}
          </h1>
        </div>
      </div>
