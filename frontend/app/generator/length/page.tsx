...
import { ArrowLeft, ArrowRight, Ruler, Send, Save, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="container mx-auto py-8 pt-20">
      ...
      <div className="text-center mt-6">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-sky-50 border border-sky-200 rounded-3xl shadow-sm">
          <Ruler className="text-sky-500 w-7 h-7" />
