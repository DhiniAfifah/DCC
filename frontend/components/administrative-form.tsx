                ...
                <div key={field.id} className="grid gap-4 border-b pb-4 relative">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div id="nip">
                      ...
                      <FormField control={form.control} name={`persons.${index}.nip`} render={({ field }) => (
                          <FormItem>
                            <FormControl><Input {...field} /></FormControl>
                            <FormMessage />
                          </FormItem>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div id="peran">
                      ...
                      <FormField control={form.control} name={`persons.${index}.peran`} render={({ field }) => (
                          <FormItem>
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              <FormControl>
                                <SelectTrigger><SelectValue /></SelectTrigger>
                    ...
                    <div id="main_signer">
                      ...
                      <FormField control={form.control} name={`persons.${index}.main_signer`} render={({ field }) => (
                          <FormItem>
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              <FormControl><SelectTrigger><SelectValue /></SelectTrigger></FormControl>
                              <SelectContent>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div id="signature">
                      ...
                      <FormField control={form.control} name={`persons.${index}.signature`} render={({ field }) => (
                          <FormItem>
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              <FormControl><SelectTrigger><SelectValue /></SelectTrigger></FormControl>
                              <SelectContent>
                    ...
                    <div id="timestamp">
                      ...
                      <FormField control={form.control} name={`persons.${index}.timestamp`} render={({ field }) => (
                          <FormItem>
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              <FormControl><SelectTrigger><SelectValue /></SelectTrigger></FormControl>
                              <SelectContent>
